...
SELECT
    ...
    employee.last_name
FROM branch
    LEFT JOIN employee ON branch.mgr_id = employee.emp_id;
...
-- SELECT cl.client_name, br.branch_name, e.first_name, e.last_name

-- FROM client cl

-- JOIN branch br ON cl.branch_id = br.branch_id

-- LEFT JOIN employee e ON br.mgr_id = e.emp_id;
